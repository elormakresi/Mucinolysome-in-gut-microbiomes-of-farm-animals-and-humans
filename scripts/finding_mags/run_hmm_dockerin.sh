...
#######################################
# to identify dockerin in protein sequences using hmmer
# input is dockerin-1.hmm and protein sequence file
#######################################
...
for faa_file in $DIR/*.faa; do
    ...
    hmmsearch -o /dev/null --noali --cpu 32 -E 0.0001 --domE 0.0001 --domtblout "${OUTPUT_DIR}/${base_name}_dockerin_domtbl.tsv" dockerin-1.hmm $faa_file
done
